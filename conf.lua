...
Config.MaxCasse = 950                       --Maximum de dommage du vehicule
Config.TempsEntre = 1000*300                --Mettre le nb de seconde apres l'etoile
Config.TempsRecherche = 1000*1800           --Mettre le nb de seconde apres l'etoile
-- 3600 = 1h
-- 1800 = 30 min
-- 900 = 15 min
-- 600 = 10 min
